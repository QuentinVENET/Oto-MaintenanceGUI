...
echo 3- Credits
echo 4- Parametres de demarrage.
echo 5- Quitter Oto-Maintenance
...
:settings
cls
echo Ouverture des parametres de demarrage dans une nouvelle fenetre.
echo Pressez une touche pour retourner a l'accueil.
start msconfig.bat
pause > nul
goto start